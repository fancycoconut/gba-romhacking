...
Option Explicit
Public iTradeAmount As Integer
Public EnlargedROM As Byte
Public iFileNum As Integer
Public TradeDataOffset As Long
Public sHeader As String * 4
Public sFilePath As String

Public iItemCount As Integer
Public PokemonPics As Long
Public PokemonPalettes As Long
Public PokemonStats As Long
Public ItemNames As Long
Public AbilityNames As Long
Public NatureNames As Long
    ...
    If InStrB(1, sAscii, "[") Then
        ...
        If InStrB(sAscii, "]") - InStrB(sAscii, "[") \ 2& - 1& > 2& Then
            ...
            ElseIf InStrB(1, sAscii, "_fr") Then
                ...
                DoReplace sAscii, "[white2_frt]", "\c\h01\h05", , , vbTextCompare
                ...
                DoReplace sAscii, "[white3_frt]", "\c\h01\h0B", , , vbTextCompare
                DoReplace sAscii, "[magenta2_frt]", "\c\h01\h0C", , , vbTextCompare
            ...
            ElseIf InStrB(1, sAscii, "_em") Then
                ...
                DoReplace sAscii, "[limegreen2_em]", "\c\h01\h0D", , , vbTextCompare
                ...
                DoReplace sAscii, "[lightgrey2_emt]", "\c\h01\h0A", , , vbTextCompare
